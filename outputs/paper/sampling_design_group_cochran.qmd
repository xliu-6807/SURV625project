...
To get the sampling interval $k_{hi} = Mos_{hi} / n_{hi} = \frac{219}{15}$, we choose a random starting number between 1 and $k_{hi}$, which is 14.6, then we use the k-interval 146 to conduct the systematic sampling.
...
## Appendix 8: Within-School Sampling Rate for 2 Strata
